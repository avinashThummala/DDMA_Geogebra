...
public class OutputFormat {
     ...
     */
    public OutputFormat(StatusBar status, LanguageManager langMan, String name, boolean implicitMult, boolean keepAsDouble) {
        this.status=status;
        autoBrackets=false;
    ...
    public void readFormatFile(String fileName) {
        try {
            formatDoc = builder.build(this.getClass().getResourceAsStream("/Output/formats/"+fileName+".xml"));
