...
public class FormatChooser extends javax.swing.JFrame {
    ...
    public FormatChooser(int type, OutputFormat output, LanguageManager langMan) {
        initComponents();
        ...
        try { 
            configFile = builder.build(this.getClass().getResourceAsStream("/Display/Config.xml"));
